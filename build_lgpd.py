...
# Define file paths
code_html_path = r"e:\01_emaus\02. Site\code.html"
privacidade_html_path = r"e:\01_emaus\02. Site\privacidade.html"
termos_html_path = r"e:\01_emaus\02. Site\termos.html"

# Read code.html
with open(code_html_path, "r", encoding="utf-8") as f:
    code = f.read()

# Separate header and footer from code.html
# 'HeroHeader' is exactly after the Nav
header = code.split("<!-- BEGIN: HeroHeader -->")[0]
footer = "  <!-- BEGIN: Footer -->" + code.split("<!-- BEGIN: Footer -->")[1]

# Privacy Policy Content
privacy = """  <!-- BEGIN: Privacy Policy -->
  <section class="py-32 bg-brand-sand/30" id="politica-de-privacidade">
...
terms = """  <!-- BEGIN: Terms of Use -->
  <section class="py-32 bg-brand-sand/30" id="termos-de-uso">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="mb-12">
...
# Write to arquivos
with open(privacidade_html_path, "w", encoding="utf-8") as f:
    f.write(header + privacy + footer)

with open(termos_html_path, "w", encoding="utf-8") as f:
